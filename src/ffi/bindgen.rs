...
pub struct Struct_sqlite3_io_methods {
    ...
    pub xFetch: ::std::option::Option<extern "C" fn
                                          ...
                                          -> ::libc::c_int>,
    pub xUnfetch: ::std::option::Option<extern "C" fn
                                            (arg1: *mut sqlite3_file,
                                             arg2: sqlite3_int64,
                                             arg3: *mut ::libc::c_void)
                                            -> ::libc::c_int>,
...
pub struct Struct_sqlite3_module {
    ...
    pub xBestIndex: ::std::option::Option<extern "C" fn
                                              (arg1: *mut sqlite3_vtab,
                                               arg2: *mut sqlite3_index_info)
                                              -> ::libc::c_int>,
    pub xDisconnect: ::std::option::Option<extern "C" fn
                                               (arg1: *mut sqlite3_vtab)
                                               -> ::libc::c_int>,
    pub xDestroy: ::std::option::Option<extern "C" fn(arg1: *mut sqlite3_vtab)
                                            -> ::libc::c_int>,
    pub xOpen: ::std::option::Option<extern "C" fn
                                         (arg1: *mut sqlite3_vtab,
                                          arg2: *mut *mut sqlite3_vtab_cursor)
                                         -> ::libc::c_int>,
    ...
    pub xUpdate: ::std::option::Option<extern "C" fn
                                           ...
                                           -> ::libc::c_int>,
    pub xBegin: ::std::option::Option<extern "C" fn(arg1: *mut sqlite3_vtab)
                                          -> ::libc::c_int>,
    pub xSync: ::std::option::Option<extern "C" fn(arg1: *mut sqlite3_vtab)
                                         -> ::libc::c_int>,
    pub xCommit: ::std::option::Option<extern "C" fn(arg1: *mut sqlite3_vtab)
                                           -> ::libc::c_int>,
...
//#[link(name = "sqlite3", kind = "framework")]
#[link(name = "sqlite3")]
extern "C" {
