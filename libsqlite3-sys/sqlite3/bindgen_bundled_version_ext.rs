...
>;
static __SQLITE3_AGGREGATE_CONTEXT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_context,
            nBytes: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_aggregate_context(
    ...
    let fun = __SQLITE3_AGGREGATE_CONTEXT
...
pub unsafe fn sqlite3_bind_blob(
    ...
    let fun = __SQLITE3_BIND_BLOB
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, n, arg4)
}

static __SQLITE3_BIND_DOUBLE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_bind_double(
    ...
    let fun = __SQLITE3_BIND_DOUBLE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_BIND_INT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_bind_int(
    ...
    let fun = __SQLITE3_BIND_INT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_BIND_INT64: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_bind_int64(
    ...
    let fun = __SQLITE3_BIND_INT64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_BIND_NULL: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_bind_null(
    ...
    let fun = __SQLITE3_BIND_NULL
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_BIND_PARAMETER_COUNT: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_stmt) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_bind_parameter_count(
    arg1: *mut sqlite3_stmt,
) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_BIND_PARAMETER_COUNT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_BIND_PARAMETER_INDEX: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            zName: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_bind_parameter_index(
    ...
    let fun = __SQLITE3_BIND_PARAMETER_INDEX
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, zName)
}

static __SQLITE3_BIND_PARAMETER_NAME: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_bind_parameter_name(
    ...
    let fun = __SQLITE3_BIND_PARAMETER_NAME
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_BIND_TEXT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_bind_text(
    ...
    let fun = __SQLITE3_BIND_TEXT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, n, arg4)
}

static __SQLITE3_BIND_TEXT16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_bind_text16(
    ...
    let fun = __SQLITE3_BIND_TEXT16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5)
}

static __SQLITE3_BIND_VALUE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_bind_value(
    ...
    let fun = __SQLITE3_BIND_VALUE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_BUSY_HANDLER: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::option::Option<
...
pub unsafe fn sqlite3_busy_handler(
    ...
    let fun = __SQLITE3_BUSY_HANDLER
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_BUSY_TIMEOUT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            ms: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_busy_timeout(
    ...
    let fun = __SQLITE3_BUSY_TIMEOUT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, ms)
}

static __SQLITE3_CHANGES: ::atomic::Atomic<
...
pub unsafe fn sqlite3_changes(arg1: *mut sqlite3) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_CHANGES
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_CLOSE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_close(arg1: *mut sqlite3) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_CLOSE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_COLLATION_NEEDED: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *mut ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_collation_needed(
    ...
    let fun = __SQLITE3_COLLATION_NEEDED
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_COLLATION_NEEDED16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *mut ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_collation_needed16(
    ...
    let fun = __SQLITE3_COLLATION_NEEDED16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_COLUMN_BLOB: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            iCol: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_blob(
    ...
    let fun = __SQLITE3_COLUMN_BLOB
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, iCol)
}

static __SQLITE3_COLUMN_BYTES: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            iCol: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_bytes(
    ...
    let fun = __SQLITE3_COLUMN_BYTES
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, iCol)
}

static __SQLITE3_COLUMN_BYTES16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            iCol: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_bytes16(
    ...
    let fun = __SQLITE3_COLUMN_BYTES16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, iCol)
}

static __SQLITE3_COLUMN_COUNT: ::atomic::Atomic<
...
pub unsafe fn sqlite3_column_count(pStmt: *mut sqlite3_stmt) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_COLUMN_COUNT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(pStmt)
}

static __SQLITE3_COLUMN_DATABASE_NAME: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_database_name(
    ...
    let fun = __SQLITE3_COLUMN_DATABASE_NAME
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_COLUMN_DATABASE_NAME16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_database_name16(
    ...
    let fun = __SQLITE3_COLUMN_DATABASE_NAME16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_COLUMN_DECLTYPE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            i: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_decltype(
    ...
    let fun = __SQLITE3_COLUMN_DECLTYPE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, i)
}

static __SQLITE3_COLUMN_DECLTYPE16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_decltype16(
    ...
    let fun = __SQLITE3_COLUMN_DECLTYPE16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_COLUMN_DOUBLE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_stmt, iCol: ::std::os::raw::c_int) -> f64,
    >,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_column_double(
    ...
    let fun = __SQLITE3_COLUMN_DOUBLE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, iCol)
}

static __SQLITE3_COLUMN_INT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            iCol: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_int(
    ...
    let fun = __SQLITE3_COLUMN_INT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, iCol)
}

static __SQLITE3_COLUMN_INT64: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            iCol: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_int64(
    ...
    let fun = __SQLITE3_COLUMN_INT64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, iCol)
}

static __SQLITE3_COLUMN_NAME: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_name(
    ...
    let fun = __SQLITE3_COLUMN_NAME
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_COLUMN_NAME16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_name16(
    ...
    let fun = __SQLITE3_COLUMN_NAME16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_COLUMN_ORIGIN_NAME: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_origin_name(
    ...
    let fun = __SQLITE3_COLUMN_ORIGIN_NAME
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_COLUMN_ORIGIN_NAME16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_origin_name16(
    ...
    let fun = __SQLITE3_COLUMN_ORIGIN_NAME16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_COLUMN_TABLE_NAME: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_table_name(
    ...
    let fun = __SQLITE3_COLUMN_TABLE_NAME
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_COLUMN_TABLE_NAME16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_table_name16(
    ...
    let fun = __SQLITE3_COLUMN_TABLE_NAME16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_COLUMN_TEXT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            iCol: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_text(
    ...
    let fun = __SQLITE3_COLUMN_TEXT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, iCol)
}

static __SQLITE3_COLUMN_TEXT16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            iCol: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_text16(
    ...
    let fun = __SQLITE3_COLUMN_TEXT16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, iCol)
}

static __SQLITE3_COLUMN_TYPE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            iCol: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_type(
    ...
    let fun = __SQLITE3_COLUMN_TYPE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, iCol)
}

static __SQLITE3_COLUMN_VALUE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            iCol: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_column_value(
    ...
    let fun = __SQLITE3_COLUMN_VALUE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, iCol)
}

static __SQLITE3_COMMIT_HOOK: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::option::Option<
...
pub unsafe fn sqlite3_commit_hook(
    ...
    let fun = __SQLITE3_COMMIT_HOOK
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_COMPLETE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(sql: *const ::std::os::raw::c_char) -> ::std::os::raw::c_int,
    >,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_complete(
    ...
    let fun = __SQLITE3_COMPLETE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(sql)
}

static __SQLITE3_COMPLETE16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(sql: *const ::std::os::raw::c_void) -> ::std::os::raw::c_int,
    >,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_complete16(
    ...
    let fun = __SQLITE3_COMPLETE16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(sql)
}

static __SQLITE3_CREATE_COLLATION: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_create_collation(
    ...
    let fun = __SQLITE3_CREATE_COLLATION
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5)
}

static __SQLITE3_CREATE_COLLATION16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_create_collation16(
    ...
    let fun = __SQLITE3_CREATE_COLLATION16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5)
}

static __SQLITE3_CREATE_FUNCTION: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_create_function(
    ...
    let fun = __SQLITE3_CREATE_FUNCTION
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5, xFunc, xStep, xFinal)
}

static __SQLITE3_CREATE_FUNCTION16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_create_function16(
    ...
    let fun = __SQLITE3_CREATE_FUNCTION16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5, xFunc, xStep, xFinal)
}

static __SQLITE3_CREATE_MODULE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_create_module(
    ...
    let fun = __SQLITE3_CREATE_MODULE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_DATA_COUNT: ::atomic::Atomic<
    Option<unsafe extern "C" fn(pStmt: *mut sqlite3_stmt) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_data_count(pStmt: *mut sqlite3_stmt) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_DATA_COUNT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(pStmt)
}

static __SQLITE3_DB_HANDLE: ::atomic::Atomic<
...
pub unsafe fn sqlite3_db_handle(arg1: *mut sqlite3_stmt) -> *mut sqlite3 {
    let fun = __SQLITE3_DB_HANDLE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_DECLARE_VTAB: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_declare_vtab(
    ...
    let fun = __SQLITE3_DECLARE_VTAB
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_ENABLE_SHARED_CACHE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: ::std::os::raw::c_int) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_enable_shared_cache(
    arg1: ::std::os::raw::c_int,
) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_ENABLE_SHARED_CACHE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_ERRCODE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(db: *mut sqlite3) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_errcode(db: *mut sqlite3) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_ERRCODE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(db)
}

static __SQLITE3_ERRMSG: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> *const ::std::os::raw::c_char>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_errmsg(arg1: *mut sqlite3) -> *const ::std::os::raw::c_char {
    let fun = __SQLITE3_ERRMSG
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_ERRMSG16: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> *const ::std::os::raw::c_void>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_errmsg16(arg1: *mut sqlite3) -> *const ::std::os::raw::c_void {
    let fun = __SQLITE3_ERRMSG16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_EXEC: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_finalize(pStmt: *mut sqlite3_stmt) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_FINALIZE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(pStmt)
}

static __SQLITE3_FREE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut ::std::os::raw::c_void)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_free(arg1: *mut ::std::os::raw::c_void) {
    let fun = __SQLITE3_FREE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_FREE_TABLE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(result: *mut *mut ::std::os::raw::c_char)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_free_table(result: *mut *mut ::std::os::raw::c_char) {
    let fun = __SQLITE3_FREE_TABLE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(result)
}

static __SQLITE3_GET_AUTOCOMMIT: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_get_autocommit(arg1: *mut sqlite3) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_GET_AUTOCOMMIT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_GET_AUXDATA: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_context,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_get_auxdata(
    ...
    let fun = __SQLITE3_GET_AUXDATA
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_GET_TABLE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_interrupt(arg1: *mut sqlite3) {
    let fun = __SQLITE3_INTERRUPT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_LAST_INSERT_ROWID: ::atomic::Atomic<
...
pub unsafe fn sqlite3_malloc(
    ...
    let fun = __SQLITE3_MALLOC
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_OPEN: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
            arg2: *mut *mut sqlite3,
...
pub unsafe fn sqlite3_open(
    ...
    let fun = __SQLITE3_OPEN
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_OPEN16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_void,
            arg2: *mut *mut sqlite3,
...
pub unsafe fn sqlite3_open16(
    ...
    let fun = __SQLITE3_OPEN16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_PREPARE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_prepare(
    ...
    let fun = __SQLITE3_PREPARE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5)
}

static __SQLITE3_PREPARE16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_prepare16(
    ...
    let fun = __SQLITE3_PREPARE16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5)
}

static __SQLITE3_PROFILE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::option::Option<
...
pub unsafe fn sqlite3_profile(
    ...
    let fun = __SQLITE3_PROFILE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_PROGRESS_HANDLER: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_progress_handler(
    ...
    let fun = __SQLITE3_PROGRESS_HANDLER
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_REALLOC: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut ::std::os::raw::c_void,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_realloc(
    ...
    let fun = __SQLITE3_REALLOC
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_RESET: ::atomic::Atomic<
    Option<unsafe extern "C" fn(pStmt: *mut sqlite3_stmt) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_reset(pStmt: *mut sqlite3_stmt) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_RESET
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(pStmt)
}

static __SQLITE3_RESULT_BLOB: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_context,
            arg2: *const ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_result_blob(
    ...
    let fun = __SQLITE3_RESULT_BLOB
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_RESULT_DOUBLE: ::atomic::Atomic<
...
pub unsafe fn sqlite3_result_double(arg1: *mut sqlite3_context, arg2: f64) {
    let fun = __SQLITE3_RESULT_DOUBLE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_RESULT_ERROR: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_context,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_result_error(
    ...
    let fun = __SQLITE3_RESULT_ERROR
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_RESULT_ERROR16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_context,
            arg2: *const ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_result_error16(
    ...
    let fun = __SQLITE3_RESULT_ERROR16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_RESULT_INT: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_context, arg2: ::std::os::raw::c_int)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_result_int(
    arg1: *mut sqlite3_context,
    arg2: ::std::os::raw::c_int,
) {
    let fun = __SQLITE3_RESULT_INT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_RESULT_INT64: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_context, arg2: sqlite_int64)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_result_int64(arg1: *mut sqlite3_context, arg2: sqlite_int64) {
    let fun = __SQLITE3_RESULT_INT64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_RESULT_NULL: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_context)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_result_null(arg1: *mut sqlite3_context) {
    let fun = __SQLITE3_RESULT_NULL
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_RESULT_TEXT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_context,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_result_text(
    ...
    let fun = __SQLITE3_RESULT_TEXT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_RESULT_TEXT16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_context,
            arg2: *const ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_result_text16(
    ...
    let fun = __SQLITE3_RESULT_TEXT16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_RESULT_TEXT16BE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_context,
            arg2: *const ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_result_text16be(
    ...
    let fun = __SQLITE3_RESULT_TEXT16BE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_RESULT_TEXT16LE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_context,
            arg2: *const ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_result_text16le(
    ...
    let fun = __SQLITE3_RESULT_TEXT16LE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_RESULT_VALUE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_context, arg2: *mut sqlite3_value)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_result_value(
    arg1: *mut sqlite3_context,
    arg2: *mut sqlite3_value,
) {
    let fun = __SQLITE3_RESULT_VALUE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_ROLLBACK_HOOK: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::option::Option<
...
pub unsafe fn sqlite3_rollback_hook(
    ...
    let fun = __SQLITE3_ROLLBACK_HOOK
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_SET_AUTHORIZER: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::option::Option<
...
pub unsafe fn sqlite3_set_authorizer(
    ...
    let fun = __SQLITE3_SET_AUTHORIZER
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_SET_AUXDATA: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_context,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_set_auxdata(
    ...
    let fun = __SQLITE3_SET_AUXDATA
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_STEP: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_stmt) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_step(arg1: *mut sqlite3_stmt) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_STEP
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_TABLE_COLUMN_METADATA: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_table_column_metadata(
    ...
    let fun = __SQLITE3_TABLE_COLUMN_METADATA
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
...
pub unsafe fn sqlite3_total_changes(arg1: *mut sqlite3) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_TOTAL_CHANGES
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_TRACE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            xTrace: ::std::option::Option<
...
pub unsafe fn sqlite3_update_hook(
    ...
    let fun = __SQLITE3_UPDATE_HOOK
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_USER_DATA: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_context) -> *mut ::std::os::raw::c_void,
    >,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_user_data(
    ...
    let fun = __SQLITE3_USER_DATA
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_BLOB: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_value) -> *const ::std::os::raw::c_void,
    >,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_blob(
    ...
    let fun = __SQLITE3_VALUE_BLOB
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_BYTES: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_bytes(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_VALUE_BYTES
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_BYTES16: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_bytes16(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_VALUE_BYTES16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_DOUBLE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_value) -> f64>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_double(arg1: *mut sqlite3_value) -> f64 {
    let fun = __SQLITE3_VALUE_DOUBLE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_INT: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_int(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_VALUE_INT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_INT64: ::atomic::Atomic<
...
pub unsafe fn sqlite3_value_int64(arg1: *mut sqlite3_value) -> sqlite_int64 {
    let fun = __SQLITE3_VALUE_INT64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_NUMERIC_TYPE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_numeric_type(
    arg1: *mut sqlite3_value,
) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_VALUE_NUMERIC_TYPE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_TEXT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_value) -> *const ::std::os::raw::c_uchar,
    >,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_text(
    ...
    let fun = __SQLITE3_VALUE_TEXT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_TEXT16: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_value) -> *const ::std::os::raw::c_void,
    >,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_text16(
    ...
    let fun = __SQLITE3_VALUE_TEXT16
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_TEXT16BE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_value) -> *const ::std::os::raw::c_void,
    >,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_text16be(
    ...
    let fun = __SQLITE3_VALUE_TEXT16BE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_TEXT16LE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_value) -> *const ::std::os::raw::c_void,
    >,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_text16le(
    ...
    let fun = __SQLITE3_VALUE_TEXT16LE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_TYPE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_type(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_VALUE_TYPE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_OVERLOAD_FUNCTION: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            zFuncName: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_overload_function(
    ...
    let fun = __SQLITE3_OVERLOAD_FUNCTION
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, zFuncName, nArg)
}

static __SQLITE3_PREPARE_V2: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_prepare_v2(
    ...
    let fun = __SQLITE3_PREPARE_V2
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5)
}

static __SQLITE3_PREPARE16_V2: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_prepare16_v2(
    ...
    let fun = __SQLITE3_PREPARE16_V2
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5)
}

static __SQLITE3_CLEAR_BINDINGS: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_stmt) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_clear_bindings(arg1: *mut sqlite3_stmt) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_CLEAR_BINDINGS
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_CREATE_MODULE_V2: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_create_module_v2(
    ...
    let fun = __SQLITE3_CREATE_MODULE_V2
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, xDestroy)
}

static __SQLITE3_BIND_ZEROBLOB: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_bind_zeroblob(
    ...
    let fun = __SQLITE3_BIND_ZEROBLOB
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_BLOB_BYTES: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_blob) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_blob_bytes(arg1: *mut sqlite3_blob) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_BLOB_BYTES
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_BLOB_CLOSE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_blob) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_blob_close(arg1: *mut sqlite3_blob) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_BLOB_CLOSE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_BLOB_OPEN: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_blob_open(
    ...
    let fun = __SQLITE3_BLOB_OPEN
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5, arg6, arg7)
}

static __SQLITE3_BLOB_READ: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_blob,
            arg2: *mut ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_blob_read(
    ...
    let fun = __SQLITE3_BLOB_READ
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_BLOB_WRITE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_blob,
            arg2: *const ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_blob_write(
    ...
    let fun = __SQLITE3_BLOB_WRITE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_CREATE_COLLATION_V2: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_create_collation_v2(
    ...
    let fun = __SQLITE3_CREATE_COLLATION_V2
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5, arg6)
}

static __SQLITE3_FILE_CONTROL: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_file_control(
    ...
    let fun = __SQLITE3_FILE_CONTROL
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_MEMORY_HIGHWATER: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: ::std::os::raw::c_int) -> sqlite3_int64>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_memory_highwater(arg1: ::std::os::raw::c_int) -> sqlite3_int64 {
    let fun = __SQLITE3_MEMORY_HIGHWATER
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_MEMORY_USED: ::atomic::Atomic<
    Option<unsafe extern "C" fn() -> sqlite3_int64>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_memory_used() -> sqlite3_int64 {
    let fun = __SQLITE3_MEMORY_USED
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)()
}

static __SQLITE3_MUTEX_ALLOC: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: ::std::os::raw::c_int) -> *mut sqlite3_mutex>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_mutex_alloc(arg1: ::std::os::raw::c_int) -> *mut sqlite3_mutex {
    let fun = __SQLITE3_MUTEX_ALLOC
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_MUTEX_ENTER: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_mutex)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_mutex_enter(arg1: *mut sqlite3_mutex) {
    let fun = __SQLITE3_MUTEX_ENTER
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_MUTEX_FREE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_mutex)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_mutex_free(arg1: *mut sqlite3_mutex) {
    let fun = __SQLITE3_MUTEX_FREE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_MUTEX_LEAVE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_mutex)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_mutex_leave(arg1: *mut sqlite3_mutex) {
    let fun = __SQLITE3_MUTEX_LEAVE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_MUTEX_TRY: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_mutex) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_mutex_try(arg1: *mut sqlite3_mutex) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_MUTEX_TRY
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_OPEN_V2: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
            arg2: *mut *mut sqlite3,
...
pub unsafe fn sqlite3_open_v2(
    ...
    let fun = __SQLITE3_OPEN_V2
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_RELEASE_MEMORY: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: ::std::os::raw::c_int) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_release_memory(
    arg1: ::std::os::raw::c_int,
) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_RELEASE_MEMORY
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_RESULT_ERROR_NOMEM: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_context)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_result_error_nomem(arg1: *mut sqlite3_context) {
    let fun = __SQLITE3_RESULT_ERROR_NOMEM
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_RESULT_ERROR_TOOBIG: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_context)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_result_error_toobig(arg1: *mut sqlite3_context) {
    let fun = __SQLITE3_RESULT_ERROR_TOOBIG
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_SLEEP: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: ::std::os::raw::c_int) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_sleep(arg1: ::std::os::raw::c_int) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_SLEEP
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_SOFT_HEAP_LIMIT: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: ::std::os::raw::c_int)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_soft_heap_limit(arg1: ::std::os::raw::c_int) {
    let fun = __SQLITE3_SOFT_HEAP_LIMIT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VFS_FIND: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *const ::std::os::raw::c_char) -> *mut sqlite3_vfs>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_vfs_find(arg1: *const ::std::os::raw::c_char) -> *mut sqlite3_vfs {
    let fun = __SQLITE3_VFS_FIND
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VFS_REGISTER: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_vfs,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_vfs_register(
    ...
    let fun = __SQLITE3_VFS_REGISTER
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_VFS_UNREGISTER: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_vfs) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_vfs_unregister(arg1: *mut sqlite3_vfs) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_VFS_UNREGISTER
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_THREADSAFE: ::atomic::Atomic<
    Option<unsafe extern "C" fn() -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_threadsafe() -> ::std::os::raw::c_int {
    let fun = __SQLITE3_THREADSAFE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)()
}

static __SQLITE3_RESULT_ZEROBLOB: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_context, arg2: ::std::os::raw::c_int)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_result_zeroblob(
    ...
    let fun = __SQLITE3_RESULT_ZEROBLOB
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_RESULT_ERROR_CODE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_context, arg2: ::std::os::raw::c_int)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_result_error_code(
    ...
    let fun = __SQLITE3_RESULT_ERROR_CODE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_RANDOMNESS: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: ::std::os::raw::c_int,
            arg2: *mut ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_randomness(
    ...
    let fun = __SQLITE3_RANDOMNESS
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_CONTEXT_DB_HANDLE: ::atomic::Atomic<
...
pub unsafe fn sqlite3_context_db_handle(arg1: *mut sqlite3_context) -> *mut sqlite3 {
    let fun = __SQLITE3_CONTEXT_DB_HANDLE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_EXTENDED_RESULT_CODES: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_extended_result_codes(
    ...
    let fun = __SQLITE3_EXTENDED_RESULT_CODES
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_LIMIT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_limit(
    ...
    let fun = __SQLITE3_LIMIT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_NEXT_STMT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *mut sqlite3_stmt,
...
pub unsafe fn sqlite3_next_stmt(
    ...
    let fun = __SQLITE3_NEXT_STMT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_SQL: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_stmt) -> *const ::std::os::raw::c_char,
    >,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_sql(arg1: *mut sqlite3_stmt) -> *const ::std::os::raw::c_char {
    let fun = __SQLITE3_SQL
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_STATUS: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: ::std::os::raw::c_int,
            arg2: *mut ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_status(
    ...
    let fun = __SQLITE3_STATUS
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_BACKUP_FINISH: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_backup) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_backup_finish(arg1: *mut sqlite3_backup) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_BACKUP_FINISH
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_BACKUP_INIT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_backup_init(
    ...
    let fun = __SQLITE3_BACKUP_INIT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_BACKUP_PAGECOUNT: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_backup) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_backup_pagecount(
    arg1: *mut sqlite3_backup,
) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_BACKUP_PAGECOUNT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_BACKUP_REMAINING: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_backup) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_backup_remaining(
    arg1: *mut sqlite3_backup,
) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_BACKUP_REMAINING
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_BACKUP_STEP: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_backup,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_backup_step(
    ...
    let fun = __SQLITE3_BACKUP_STEP
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_COMPILEOPTION_GET: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: ::std::os::raw::c_int,
        ) -> *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_compileoption_get(
    ...
    let fun = __SQLITE3_COMPILEOPTION_GET
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_COMPILEOPTION_USED: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
        ) -> ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_compileoption_used(
    ...
    let fun = __SQLITE3_COMPILEOPTION_USED
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_CREATE_FUNCTION_V2: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_create_function_v2(
    ...
    let fun = __SQLITE3_CREATE_FUNCTION_V2
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5, xFunc, xStep, xFinal, xDestroy)
}

static __SQLITE3_DB_CONFIG: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_db_config(
    ...
    let fun = __SQLITE3_DB_CONFIG
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_DB_MUTEX: ::atomic::Atomic<
...
pub unsafe fn sqlite3_db_mutex(arg1: *mut sqlite3) -> *mut sqlite3_mutex {
    let fun = __SQLITE3_DB_MUTEX
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_DB_STATUS: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_db_status(
    ...
    let fun = __SQLITE3_DB_STATUS
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5)
}

static __SQLITE3_EXTENDED_ERRCODE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_extended_errcode(arg1: *mut sqlite3) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_EXTENDED_ERRCODE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_LOG: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: ::std::os::raw::c_int,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_log(
    ...
    let fun = __SQLITE3_LOG
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_SOFT_HEAP_LIMIT64: ::atomic::Atomic<
...
pub unsafe fn sqlite3_soft_heap_limit64(arg1: sqlite3_int64) -> sqlite3_int64 {
    let fun = __SQLITE3_SOFT_HEAP_LIMIT64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_SOURCEID: ::atomic::Atomic<
    Option<unsafe extern "C" fn() -> *const ::std::os::raw::c_char>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_sourceid() -> *const ::std::os::raw::c_char {
    let fun = __SQLITE3_SOURCEID
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)()
}

static __SQLITE3_STMT_STATUS: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_stmt_status(
    ...
    let fun = __SQLITE3_STMT_STATUS
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_STRNICMP: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_strnicmp(
    ...
    let fun = __SQLITE3_STRNICMP
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_UNLOCK_NOTIFY: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::option::Option<
...
pub unsafe fn sqlite3_unlock_notify(
    ...
    let fun = __SQLITE3_UNLOCK_NOTIFY
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_WAL_AUTOCHECKPOINT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_wal_autocheckpoint(
    ...
    let fun = __SQLITE3_WAL_AUTOCHECKPOINT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_WAL_CHECKPOINT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_wal_checkpoint(
    ...
    let fun = __SQLITE3_WAL_CHECKPOINT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_WAL_HOOK: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::option::Option<
...
pub unsafe fn sqlite3_wal_hook(
    ...
    let fun = __SQLITE3_WAL_HOOK
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_BLOB_REOPEN: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_blob,
            arg2: sqlite3_int64,
...
pub unsafe fn sqlite3_blob_reopen(
    ...
    let fun = __SQLITE3_BLOB_REOPEN
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_VTAB_CONFIG: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            op: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_vtab_config(
    ...
    let fun = __SQLITE3_VTAB_CONFIG
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, op)
}

static __SQLITE3_VTAB_ON_CONFLICT: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_vtab_on_conflict(arg1: *mut sqlite3) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_VTAB_ON_CONFLICT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_CLOSE_V2: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_close_v2(arg1: *mut sqlite3) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_CLOSE_V2
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_DB_FILENAME: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_db_filename(
    ...
    let fun = __SQLITE3_DB_FILENAME
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_DB_READONLY: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_db_readonly(
    ...
    let fun = __SQLITE3_DB_READONLY
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_DB_RELEASE_MEMORY: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_db_release_memory(arg1: *mut sqlite3) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_DB_RELEASE_MEMORY
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_ERRSTR: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: ::std::os::raw::c_int,
        ) -> *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_errstr(
    ...
    let fun = __SQLITE3_ERRSTR
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_STMT_BUSY: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_stmt) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_stmt_busy(arg1: *mut sqlite3_stmt) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_STMT_BUSY
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_STMT_READONLY: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_stmt) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_stmt_readonly(arg1: *mut sqlite3_stmt) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_STMT_READONLY
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_STRICMP: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_stricmp(
    ...
    let fun = __SQLITE3_STRICMP
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_URI_BOOLEAN: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_uri_boolean(
    ...
    let fun = __SQLITE3_URI_BOOLEAN
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_URI_INT64: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_uri_int64(
    ...
    let fun = __SQLITE3_URI_INT64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_URI_PARAMETER: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_uri_parameter(
    ...
    let fun = __SQLITE3_URI_PARAMETER
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}
...
pub unsafe fn sqlite3_wal_checkpoint_v2(
    ...
    let fun = __SQLITE3_WAL_CHECKPOINT_V2
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5)
}

static __SQLITE3_AUTO_EXTENSION: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: ::std::option::Option<unsafe extern "C" fn()>,
        ) -> ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_auto_extension(
    ...
    let fun = __SQLITE3_AUTO_EXTENSION
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_BIND_BLOB64: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_bind_blob64(
    ...
    let fun = __SQLITE3_BIND_BLOB64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5)
}

static __SQLITE3_BIND_TEXT64: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_bind_text64(
    ...
    let fun = __SQLITE3_BIND_TEXT64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5, arg6)
}

static __SQLITE3_CANCEL_AUTO_EXTENSION: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: ::std::option::Option<unsafe extern "C" fn()>,
        ) -> ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_cancel_auto_extension(
    ...
    let fun = __SQLITE3_CANCEL_AUTO_EXTENSION
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_LOAD_EXTENSION: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_load_extension(
    ...
    let fun = __SQLITE3_LOAD_EXTENSION
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_MALLOC64: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: sqlite3_uint64) -> *mut ::std::os::raw::c_void>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_malloc64(arg1: sqlite3_uint64) -> *mut ::std::os::raw::c_void {
    let fun = __SQLITE3_MALLOC64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_MSIZE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut ::std::os::raw::c_void) -> sqlite3_uint64>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_msize(arg1: *mut ::std::os::raw::c_void) -> sqlite3_uint64 {
    let fun = __SQLITE3_MSIZE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_REALLOC64: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut ::std::os::raw::c_void,
            arg2: sqlite3_uint64,
...
pub unsafe fn sqlite3_realloc64(
    ...
    let fun = __SQLITE3_REALLOC64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_RESET_AUTO_EXTENSION: ::atomic::Atomic<
    Option<unsafe extern "C" fn()>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_reset_auto_extension() {
    let fun = __SQLITE3_RESET_AUTO_EXTENSION
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)()
}

static __SQLITE3_RESULT_BLOB64: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_context,
            arg2: *const ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_result_blob64(
    ...
    let fun = __SQLITE3_RESULT_BLOB64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_RESULT_TEXT64: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_context,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_result_text64(
    ...
    let fun = __SQLITE3_RESULT_TEXT64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5)
}

static __SQLITE3_STRGLOB: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_strglob(
    ...
    let fun = __SQLITE3_STRGLOB
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_VALUE_DUP: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *const sqlite3_value) -> *mut sqlite3_value>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_dup(arg1: *const sqlite3_value) -> *mut sqlite3_value {
    let fun = __SQLITE3_VALUE_DUP
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_FREE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_value)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_free(arg1: *mut sqlite3_value) {
    let fun = __SQLITE3_VALUE_FREE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_RESULT_ZEROBLOB64: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_context,
            arg2: sqlite3_uint64,
...
pub unsafe fn sqlite3_result_zeroblob64(
    ...
    let fun = __SQLITE3_RESULT_ZEROBLOB64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_BIND_ZEROBLOB64: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_bind_zeroblob64(
    ...
    let fun = __SQLITE3_BIND_ZEROBLOB64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_VALUE_SUBTYPE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_value) -> ::std::os::raw::c_uint>,
> = ::atomic::Atomic::new(None);
...
static __SQLITE3_RESULT_SUBTYPE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_context, arg2: ::std::os::raw::c_uint),
    >,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_result_subtype(
    ...
    let fun = __SQLITE3_RESULT_SUBTYPE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_STATUS64: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: ::std::os::raw::c_int,
            arg2: *mut sqlite3_int64,
...
pub unsafe fn sqlite3_status64(
    ...
    let fun = __SQLITE3_STATUS64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_STRLIKE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_strlike(
    ...
    let fun = __SQLITE3_STRLIKE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_DB_CACHEFLUSH: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_db_cacheflush(arg1: *mut sqlite3) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_DB_CACHEFLUSH
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_SYSTEM_ERRNO: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_system_errno(arg1: *mut sqlite3) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_SYSTEM_ERRNO
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_TRACE_V2: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::os::raw::c_uint,
...
pub unsafe fn sqlite3_trace_v2(
    ...
    let fun = __SQLITE3_TRACE_V2
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_EXPANDED_SQL: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_stmt) -> *mut ::std::os::raw::c_char>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_expanded_sql(
    arg1: *mut sqlite3_stmt,
) -> *mut ::std::os::raw::c_char {
    let fun = __SQLITE3_EXPANDED_SQL
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_SET_LAST_INSERT_ROWID: ::atomic::Atomic<
...
pub unsafe fn sqlite3_set_last_insert_rowid(arg1: *mut sqlite3, arg2: sqlite3_int64) {
    let fun = __SQLITE3_SET_LAST_INSERT_ROWID
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_PREPARE_V3: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_prepare_v3(
    ...
    let fun = __SQLITE3_PREPARE_V3
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5, arg6)
}

static __SQLITE3_PREPARE16_V3: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_prepare16_v3(
    ...
    let fun = __SQLITE3_PREPARE16_V3
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5, arg6)
}

static __SQLITE3_BIND_POINTER: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_stmt,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_bind_pointer(
    ...
    let fun = __SQLITE3_BIND_POINTER
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5)
}

static __SQLITE3_RESULT_POINTER: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_context,
            arg2: *mut ::std::os::raw::c_void,
...
pub unsafe fn sqlite3_result_pointer(
    ...
    let fun = __SQLITE3_RESULT_POINTER
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_VALUE_POINTER: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_value,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_value_pointer(
    ...
    let fun = __SQLITE3_VALUE_POINTER
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_VTAB_NOCHANGE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_context) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_vtab_nochange(
    arg1: *mut sqlite3_context,
) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_VTAB_NOCHANGE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_NOCHANGE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_nochange(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_VALUE_NOCHANGE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VTAB_COLLATION: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_index_info,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_vtab_collation(
    ...
    let fun = __SQLITE3_VTAB_COLLATION
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_KEYWORD_COUNT: ::atomic::Atomic<
    Option<unsafe extern "C" fn() -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_keyword_count() -> ::std::os::raw::c_int {
    let fun = __SQLITE3_KEYWORD_COUNT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)()
}

static __SQLITE3_KEYWORD_NAME: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: ::std::os::raw::c_int,
            arg2: *mut *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_keyword_name(
    ...
    let fun = __SQLITE3_KEYWORD_NAME
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_KEYWORD_CHECK: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_keyword_check(
    ...
    let fun = __SQLITE3_KEYWORD_CHECK
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_STR_NEW: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> *mut sqlite3_str>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_str_new(arg1: *mut sqlite3) -> *mut sqlite3_str {
    let fun = __SQLITE3_STR_NEW
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_STR_FINISH: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_str) -> *mut ::std::os::raw::c_char>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_str_finish(arg1: *mut sqlite3_str) -> *mut ::std::os::raw::c_char {
    let fun = __SQLITE3_STR_FINISH
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_STR_APPEND: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_str,
            zIn: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_str_append(
    ...
    let fun = __SQLITE3_STR_APPEND
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, zIn, N)
}

static __SQLITE3_STR_APPENDALL: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_str, zIn: *const ::std::os::raw::c_char),
    >,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_str_appendall(
    ...
    let fun = __SQLITE3_STR_APPENDALL
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, zIn)
}

static __SQLITE3_STR_APPENDCHAR: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_str,
            N: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_str_appendchar(
    ...
    let fun = __SQLITE3_STR_APPENDCHAR
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, N, C)
}

static __SQLITE3_STR_RESET: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_str)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_str_reset(arg1: *mut sqlite3_str) {
    let fun = __SQLITE3_STR_RESET
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_STR_ERRCODE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_str) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_str_errcode(arg1: *mut sqlite3_str) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_STR_ERRCODE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_STR_LENGTH: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_str) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_str_length(arg1: *mut sqlite3_str) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_STR_LENGTH
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_STR_VALUE: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_str) -> *mut ::std::os::raw::c_char>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_str_value(arg1: *mut sqlite3_str) -> *mut ::std::os::raw::c_char {
    let fun = __SQLITE3_STR_VALUE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_CREATE_WINDOW_FUNCTION: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_create_window_function(
    ...
    let fun = __SQLITE3_CREATE_WINDOW_FUNCTION
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5, xStep, xFinal, xValue, xInv, xDestroy)
}

static __SQLITE3_NORMALIZED_SQL: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(arg1: *mut sqlite3_stmt) -> *const ::std::os::raw::c_char,
    >,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_normalized_sql(
    ...
    let fun = __SQLITE3_NORMALIZED_SQL
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_STMT_ISEXPLAIN: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_stmt) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_stmt_isexplain(arg1: *mut sqlite3_stmt) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_STMT_ISEXPLAIN
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VALUE_FROMBIND: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_frombind(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_VALUE_FROMBIND
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_DROP_MODULES: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *mut *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_drop_modules(
    ...
    let fun = __SQLITE3_DROP_MODULES
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_HARD_HEAP_LIMIT64: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: sqlite3_int64) -> sqlite3_int64>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_hard_heap_limit64(arg1: sqlite3_int64) -> sqlite3_int64 {
    let fun = __SQLITE3_HARD_HEAP_LIMIT64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_URI_KEY: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_uri_key(
    ...
    let fun = __SQLITE3_URI_KEY
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_FILENAME_DATABASE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
        ) -> *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_filename_database(
    ...
    let fun = __SQLITE3_FILENAME_DATABASE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_FILENAME_JOURNAL: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
        ) -> *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_filename_journal(
    ...
    let fun = __SQLITE3_FILENAME_JOURNAL
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_FILENAME_WAL: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
        ) -> *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_filename_wal(
    ...
    let fun = __SQLITE3_FILENAME_WAL
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_CREATE_FILENAME: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *const ::std::os::raw::c_char,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_create_filename(
    ...
    let fun = __SQLITE3_CREATE_FILENAME
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5)
}

static __SQLITE3_FREE_FILENAME: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *const ::std::os::raw::c_char)>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_free_filename(arg1: *const ::std::os::raw::c_char) {
    let fun = __SQLITE3_FREE_FILENAME
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_DATABASE_FILE_OBJECT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(arg1: *const ::std::os::raw::c_char) -> *mut sqlite3_file,
    >,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_database_file_object(
    ...
    let fun = __SQLITE3_DATABASE_FILE_OBJECT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_TXN_STATE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_txn_state(
    ...
    let fun = __SQLITE3_TXN_STATE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_CHANGES64: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> sqlite3_int64>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_changes64(arg1: *mut sqlite3) -> sqlite3_int64 {
    let fun = __SQLITE3_CHANGES64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_TOTAL_CHANGES64: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> sqlite3_int64>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_total_changes64(arg1: *mut sqlite3) -> sqlite3_int64 {
    let fun = __SQLITE3_TOTAL_CHANGES64
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_AUTOVACUUM_PAGES: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::option::Option<
...
pub unsafe fn sqlite3_autovacuum_pages(
    ...
    let fun = __SQLITE3_AUTOVACUUM_PAGES
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_ERROR_OFFSET: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_error_offset(arg1: *mut sqlite3) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_ERROR_OFFSET
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VTAB_RHS_VALUE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_index_info,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_vtab_rhs_value(
    ...
    let fun = __SQLITE3_VTAB_RHS_VALUE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_VTAB_DISTINCT: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_index_info) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_vtab_distinct(
    arg1: *mut sqlite3_index_info,
) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_VTAB_DISTINCT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_VTAB_IN: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_index_info,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_vtab_in(
    ...
    let fun = __SQLITE3_VTAB_IN
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3)
}

static __SQLITE3_VTAB_IN_FIRST: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_value,
            arg2: *mut *mut sqlite3_value,
...
pub unsafe fn sqlite3_vtab_in_first(
    ...
    let fun = __SQLITE3_VTAB_IN_FIRST
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_VTAB_IN_NEXT: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3_value,
            arg2: *mut *mut sqlite3_value,
...
pub unsafe fn sqlite3_vtab_in_next(
    ...
    let fun = __SQLITE3_VTAB_IN_NEXT
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_DESERIALIZE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_deserialize(
    ...
    let fun = __SQLITE3_DESERIALIZE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4, arg5, arg6)
}

static __SQLITE3_SERIALIZE: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: *const ::std::os::raw::c_char,
...
pub unsafe fn sqlite3_serialize(
    ...
    let fun = __SQLITE3_SERIALIZE
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2, arg3, arg4)
}

static __SQLITE3_DB_NAME: ::atomic::Atomic<
    Option<
        unsafe extern "C" fn(
            arg1: *mut sqlite3,
            arg2: ::std::os::raw::c_int,
...
pub unsafe fn sqlite3_db_name(
    ...
    let fun = __SQLITE3_DB_NAME
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1, arg2)
}

static __SQLITE3_VALUE_ENCODING: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_value_encoding(arg1: *mut sqlite3_value) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_VALUE_ENCODING
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}

static __SQLITE3_IS_INTERRUPTED: ::atomic::Atomic<
    Option<unsafe extern "C" fn(arg1: *mut sqlite3) -> ::std::os::raw::c_int>,
> = ::atomic::Atomic::new(None);
pub unsafe fn sqlite3_is_interrupted(arg1: *mut sqlite3) -> ::std::os::raw::c_int {
    let fun = __SQLITE3_IS_INTERRUPTED
        .load(::atomic::Ordering::Acquire)
        .expect("SQLite API not initialized or SQLite feature omitted");
    (fun)(arg1)
}
...
pub unsafe fn rusqlite_extension_init2(
    ...
    __SQLITE3_BIND_INT64.store((*p_api).bind_int64, ::atomic::Ordering::Release);
    __SQLITE3_BIND_NULL.store((*p_api).bind_null, ::atomic::Ordering::Release);
    __SQLITE3_BIND_PARAMETER_COUNT
        .store((*p_api).bind_parameter_count, ::atomic::Ordering::Release);
    __SQLITE3_BIND_PARAMETER_INDEX
        .store((*p_api).bind_parameter_index, ::atomic::Ordering::Release);
    __SQLITE3_BIND_PARAMETER_NAME
        .store((*p_api).bind_parameter_name, ::atomic::Ordering::Release);
    __SQLITE3_BIND_TEXT.store((*p_api).bind_text, ::atomic::Ordering::Release);
    __SQLITE3_BIND_TEXT16.store((*p_api).bind_text16, ::atomic::Ordering::Release);
    __SQLITE3_BIND_VALUE.store((*p_api).bind_value, ::atomic::Ordering::Release);
    __SQLITE3_BUSY_HANDLER.store((*p_api).busy_handler, ::atomic::Ordering::Release);
    __SQLITE3_BUSY_TIMEOUT.store((*p_api).busy_timeout, ::atomic::Ordering::Release);
    __SQLITE3_CHANGES.store((*p_api).changes, ::atomic::Ordering::Release);
    __SQLITE3_CLOSE.store((*p_api).close, ::atomic::Ordering::Release);
    __SQLITE3_COLLATION_NEEDED
        .store((*p_api).collation_needed, ::atomic::Ordering::Release);
    __SQLITE3_COLLATION_NEEDED16
        .store((*p_api).collation_needed16, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_BLOB.store((*p_api).column_blob, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_BYTES.store((*p_api).column_bytes, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_BYTES16.store((*p_api).column_bytes16, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_COUNT.store((*p_api).column_count, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_DATABASE_NAME
        .store((*p_api).column_database_name, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_DATABASE_NAME16
        .store((*p_api).column_database_name16, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_DECLTYPE
        .store((*p_api).column_decltype, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_DECLTYPE16
        .store((*p_api).column_decltype16, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_DOUBLE.store((*p_api).column_double, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_INT.store((*p_api).column_int, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_INT64.store((*p_api).column_int64, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_NAME.store((*p_api).column_name, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_NAME16.store((*p_api).column_name16, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_ORIGIN_NAME
        .store((*p_api).column_origin_name, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_ORIGIN_NAME16
        .store((*p_api).column_origin_name16, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_TABLE_NAME
        .store((*p_api).column_table_name, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_TABLE_NAME16
        .store((*p_api).column_table_name16, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_TEXT.store((*p_api).column_text, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_TEXT16.store((*p_api).column_text16, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_TYPE.store((*p_api).column_type, ::atomic::Ordering::Release);
    __SQLITE3_COLUMN_VALUE.store((*p_api).column_value, ::atomic::Ordering::Release);
    __SQLITE3_COMMIT_HOOK.store((*p_api).commit_hook, ::atomic::Ordering::Release);
    __SQLITE3_COMPLETE.store((*p_api).complete, ::atomic::Ordering::Release);
    __SQLITE3_COMPLETE16.store((*p_api).complete16, ::atomic::Ordering::Release);
    __SQLITE3_CREATE_COLLATION
        .store((*p_api).create_collation, ::atomic::Ordering::Release);
    __SQLITE3_CREATE_COLLATION16
        .store((*p_api).create_collation16, ::atomic::Ordering::Release);
    __SQLITE3_CREATE_FUNCTION
        .store((*p_api).create_function, ::atomic::Ordering::Release);
    __SQLITE3_CREATE_FUNCTION16
        .store((*p_api).create_function16, ::atomic::Ordering::Release);
    __SQLITE3_CREATE_MODULE.store((*p_api).create_module, ::atomic::Ordering::Release);
    __SQLITE3_DATA_COUNT.store((*p_api).data_count, ::atomic::Ordering::Release);
    __SQLITE3_DB_HANDLE.store((*p_api).db_handle, ::atomic::Ordering::Release);
    __SQLITE3_DECLARE_VTAB.store((*p_api).declare_vtab, ::atomic::Ordering::Release);
    __SQLITE3_ENABLE_SHARED_CACHE
        .store((*p_api).enable_shared_cache, ::atomic::Ordering::Release);
    __SQLITE3_ERRCODE.store((*p_api).errcode, ::atomic::Ordering::Release);
    ...
    __SQLITE3_PREPARE16.store((*p_api).prepare16, ::atomic::Ordering::Release);
    __SQLITE3_PROFILE.store((*p_api).profile, ::atomic::Ordering::Release);
    __SQLITE3_PROGRESS_HANDLER
        .store((*p_api).progress_handler, ::atomic::Ordering::Release);
    __SQLITE3_REALLOC.store((*p_api).realloc, ::atomic::Ordering::Release);
    __SQLITE3_RESET.store((*p_api).reset, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_BLOB.store((*p_api).result_blob, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_DOUBLE.store((*p_api).result_double, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_ERROR.store((*p_api).result_error, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_ERROR16.store((*p_api).result_error16, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_INT.store((*p_api).result_int, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_INT64.store((*p_api).result_int64, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_NULL.store((*p_api).result_null, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_TEXT.store((*p_api).result_text, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_TEXT16.store((*p_api).result_text16, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_TEXT16BE
        .store((*p_api).result_text16be, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_TEXT16LE
        .store((*p_api).result_text16le, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_VALUE.store((*p_api).result_value, ::atomic::Ordering::Release);
    __SQLITE3_ROLLBACK_HOOK.store((*p_api).rollback_hook, ::atomic::Ordering::Release);
    __SQLITE3_SET_AUTHORIZER.store((*p_api).set_authorizer, ::atomic::Ordering::Release);
    __SQLITE3_SET_AUXDATA.store((*p_api).set_auxdata, ::atomic::Ordering::Release);
    ...
    __SQLITE3_VALUE_BYTES.store((*p_api).value_bytes, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_BYTES16.store((*p_api).value_bytes16, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_DOUBLE.store((*p_api).value_double, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_INT.store((*p_api).value_int, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_INT64.store((*p_api).value_int64, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_NUMERIC_TYPE
        .store((*p_api).value_numeric_type, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_TEXT.store((*p_api).value_text, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_TEXT16.store((*p_api).value_text16, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_TEXT16BE.store((*p_api).value_text16be, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_TEXT16LE.store((*p_api).value_text16le, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_TYPE.store((*p_api).value_type, ::atomic::Ordering::Release);
    __SQLITE3_OVERLOAD_FUNCTION
        .store((*p_api).overload_function, ::atomic::Ordering::Release);
    __SQLITE3_PREPARE_V2.store((*p_api).prepare_v2, ::atomic::Ordering::Release);
    __SQLITE3_PREPARE16_V2.store((*p_api).prepare16_v2, ::atomic::Ordering::Release);
    __SQLITE3_CLEAR_BINDINGS.store((*p_api).clear_bindings, ::atomic::Ordering::Release);
    __SQLITE3_CREATE_MODULE_V2
        .store((*p_api).create_module_v2, ::atomic::Ordering::Release);
    __SQLITE3_BIND_ZEROBLOB.store((*p_api).bind_zeroblob, ::atomic::Ordering::Release);
    __SQLITE3_BLOB_BYTES.store((*p_api).blob_bytes, ::atomic::Ordering::Release);
    __SQLITE3_BLOB_CLOSE.store((*p_api).blob_close, ::atomic::Ordering::Release);
    __SQLITE3_BLOB_OPEN.store((*p_api).blob_open, ::atomic::Ordering::Release);
    __SQLITE3_BLOB_READ.store((*p_api).blob_read, ::atomic::Ordering::Release);
    __SQLITE3_BLOB_WRITE.store((*p_api).blob_write, ::atomic::Ordering::Release);
    __SQLITE3_CREATE_COLLATION_V2
        .store((*p_api).create_collation_v2, ::atomic::Ordering::Release);
    __SQLITE3_FILE_CONTROL.store((*p_api).file_control, ::atomic::Ordering::Release);
    __SQLITE3_MEMORY_HIGHWATER
        .store((*p_api).memory_highwater, ::atomic::Ordering::Release);
    __SQLITE3_MEMORY_USED.store((*p_api).memory_used, ::atomic::Ordering::Release);
    __SQLITE3_MUTEX_ALLOC.store((*p_api).mutex_alloc, ::atomic::Ordering::Release);
    __SQLITE3_MUTEX_ENTER.store((*p_api).mutex_enter, ::atomic::Ordering::Release);
    __SQLITE3_MUTEX_FREE.store((*p_api).mutex_free, ::atomic::Ordering::Release);
    __SQLITE3_MUTEX_LEAVE.store((*p_api).mutex_leave, ::atomic::Ordering::Release);
    __SQLITE3_MUTEX_TRY.store((*p_api).mutex_try, ::atomic::Ordering::Release);
    __SQLITE3_OPEN_V2.store((*p_api).open_v2, ::atomic::Ordering::Release);
    __SQLITE3_RELEASE_MEMORY.store((*p_api).release_memory, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_ERROR_NOMEM
        .store((*p_api).result_error_nomem, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_ERROR_TOOBIG
        .store((*p_api).result_error_toobig, ::atomic::Ordering::Release);
    __SQLITE3_SLEEP.store((*p_api).sleep, ::atomic::Ordering::Release);
    __SQLITE3_SOFT_HEAP_LIMIT
        .store((*p_api).soft_heap_limit, ::atomic::Ordering::Release);
    __SQLITE3_VFS_FIND.store((*p_api).vfs_find, ::atomic::Ordering::Release);
    __SQLITE3_VFS_REGISTER.store((*p_api).vfs_register, ::atomic::Ordering::Release);
    __SQLITE3_VFS_UNREGISTER.store((*p_api).vfs_unregister, ::atomic::Ordering::Release);
    __SQLITE3_THREADSAFE.store((*p_api).xthreadsafe, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_ZEROBLOB
        .store((*p_api).result_zeroblob, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_ERROR_CODE
        .store((*p_api).result_error_code, ::atomic::Ordering::Release);
    __SQLITE3_RANDOMNESS.store((*p_api).randomness, ::atomic::Ordering::Release);
    __SQLITE3_CONTEXT_DB_HANDLE
        .store((*p_api).context_db_handle, ::atomic::Ordering::Release);
    __SQLITE3_EXTENDED_RESULT_CODES
        .store((*p_api).extended_result_codes, ::atomic::Ordering::Release);
    __SQLITE3_LIMIT.store((*p_api).limit, ::atomic::Ordering::Release);
    __SQLITE3_NEXT_STMT.store((*p_api).next_stmt, ::atomic::Ordering::Release);
    __SQLITE3_SQL.store((*p_api).sql, ::atomic::Ordering::Release);
    __SQLITE3_STATUS.store((*p_api).status, ::atomic::Ordering::Release);
    __SQLITE3_BACKUP_FINISH.store((*p_api).backup_finish, ::atomic::Ordering::Release);
    __SQLITE3_BACKUP_INIT.store((*p_api).backup_init, ::atomic::Ordering::Release);
    __SQLITE3_BACKUP_PAGECOUNT
        .store((*p_api).backup_pagecount, ::atomic::Ordering::Release);
    __SQLITE3_BACKUP_REMAINING
        .store((*p_api).backup_remaining, ::atomic::Ordering::Release);
    __SQLITE3_BACKUP_STEP.store((*p_api).backup_step, ::atomic::Ordering::Release);
    __SQLITE3_COMPILEOPTION_GET
        .store((*p_api).compileoption_get, ::atomic::Ordering::Release);
    __SQLITE3_COMPILEOPTION_USED
        .store((*p_api).compileoption_used, ::atomic::Ordering::Release);
    __SQLITE3_CREATE_FUNCTION_V2
        .store((*p_api).create_function_v2, ::atomic::Ordering::Release);
    __SQLITE3_DB_CONFIG.store((*p_api).db_config, ::atomic::Ordering::Release);
    __SQLITE3_DB_MUTEX.store((*p_api).db_mutex, ::atomic::Ordering::Release);
    __SQLITE3_DB_STATUS.store((*p_api).db_status, ::atomic::Ordering::Release);
    __SQLITE3_EXTENDED_ERRCODE
        .store((*p_api).extended_errcode, ::atomic::Ordering::Release);
    __SQLITE3_LOG.store((*p_api).log, ::atomic::Ordering::Release);
    __SQLITE3_SOFT_HEAP_LIMIT64
        .store((*p_api).soft_heap_limit64, ::atomic::Ordering::Release);
    __SQLITE3_SOURCEID.store((*p_api).sourceid, ::atomic::Ordering::Release);
    __SQLITE3_STMT_STATUS.store((*p_api).stmt_status, ::atomic::Ordering::Release);
    __SQLITE3_STRNICMP.store((*p_api).strnicmp, ::atomic::Ordering::Release);
    __SQLITE3_UNLOCK_NOTIFY.store((*p_api).unlock_notify, ::atomic::Ordering::Release);
    __SQLITE3_WAL_AUTOCHECKPOINT
        .store((*p_api).wal_autocheckpoint, ::atomic::Ordering::Release);
    __SQLITE3_WAL_CHECKPOINT.store((*p_api).wal_checkpoint, ::atomic::Ordering::Release);
    __SQLITE3_WAL_HOOK.store((*p_api).wal_hook, ::atomic::Ordering::Release);
    __SQLITE3_BLOB_REOPEN.store((*p_api).blob_reopen, ::atomic::Ordering::Release);
    __SQLITE3_VTAB_CONFIG.store((*p_api).vtab_config, ::atomic::Ordering::Release);
    __SQLITE3_VTAB_ON_CONFLICT
        .store((*p_api).vtab_on_conflict, ::atomic::Ordering::Release);
    __SQLITE3_CLOSE_V2.store((*p_api).close_v2, ::atomic::Ordering::Release);
    __SQLITE3_DB_FILENAME.store((*p_api).db_filename, ::atomic::Ordering::Release);
    __SQLITE3_DB_READONLY.store((*p_api).db_readonly, ::atomic::Ordering::Release);
    __SQLITE3_DB_RELEASE_MEMORY
        .store((*p_api).db_release_memory, ::atomic::Ordering::Release);
    __SQLITE3_ERRSTR.store((*p_api).errstr, ::atomic::Ordering::Release);
    __SQLITE3_STMT_BUSY.store((*p_api).stmt_busy, ::atomic::Ordering::Release);
    __SQLITE3_STMT_READONLY.store((*p_api).stmt_readonly, ::atomic::Ordering::Release);
    __SQLITE3_STRICMP.store((*p_api).stricmp, ::atomic::Ordering::Release);
    ...
    __SQLITE3_BIND_BLOB64.store((*p_api).bind_blob64, ::atomic::Ordering::Release);
    __SQLITE3_BIND_TEXT64.store((*p_api).bind_text64, ::atomic::Ordering::Release);
    __SQLITE3_CANCEL_AUTO_EXTENSION
        .store((*p_api).cancel_auto_extension, ::atomic::Ordering::Release);
    __SQLITE3_LOAD_EXTENSION.store((*p_api).load_extension, ::atomic::Ordering::Release);
    __SQLITE3_MALLOC64.store((*p_api).malloc64, ::atomic::Ordering::Release);
    __SQLITE3_MSIZE.store((*p_api).msize, ::atomic::Ordering::Release);
    __SQLITE3_REALLOC64.store((*p_api).realloc64, ::atomic::Ordering::Release);
    __SQLITE3_RESET_AUTO_EXTENSION
        .store((*p_api).reset_auto_extension, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_BLOB64.store((*p_api).result_blob64, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_TEXT64.store((*p_api).result_text64, ::atomic::Ordering::Release);
    __SQLITE3_STRGLOB.store((*p_api).strglob, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_DUP.store((*p_api).value_dup, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_FREE.store((*p_api).value_free, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_ZEROBLOB64
        .store((*p_api).result_zeroblob64, ::atomic::Ordering::Release);
    __SQLITE3_BIND_ZEROBLOB64
        .store((*p_api).bind_zeroblob64, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_SUBTYPE.store((*p_api).value_subtype, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_SUBTYPE.store((*p_api).result_subtype, ::atomic::Ordering::Release);
    __SQLITE3_STATUS64.store((*p_api).status64, ::atomic::Ordering::Release);
    __SQLITE3_STRLIKE.store((*p_api).strlike, ::atomic::Ordering::Release);
    __SQLITE3_DB_CACHEFLUSH.store((*p_api).db_cacheflush, ::atomic::Ordering::Release);
    __SQLITE3_SYSTEM_ERRNO.store((*p_api).system_errno, ::atomic::Ordering::Release);
    __SQLITE3_TRACE_V2.store((*p_api).trace_v2, ::atomic::Ordering::Release);
    __SQLITE3_EXPANDED_SQL.store((*p_api).expanded_sql, ::atomic::Ordering::Release);
    __SQLITE3_SET_LAST_INSERT_ROWID
        .store((*p_api).set_last_insert_rowid, ::atomic::Ordering::Release);
    __SQLITE3_PREPARE_V3.store((*p_api).prepare_v3, ::atomic::Ordering::Release);
    __SQLITE3_PREPARE16_V3.store((*p_api).prepare16_v3, ::atomic::Ordering::Release);
    __SQLITE3_BIND_POINTER.store((*p_api).bind_pointer, ::atomic::Ordering::Release);
    __SQLITE3_RESULT_POINTER.store((*p_api).result_pointer, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_POINTER.store((*p_api).value_pointer, ::atomic::Ordering::Release);
    __SQLITE3_VTAB_NOCHANGE.store((*p_api).vtab_nochange, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_NOCHANGE.store((*p_api).value_nochange, ::atomic::Ordering::Release);
    __SQLITE3_VTAB_COLLATION.store((*p_api).vtab_collation, ::atomic::Ordering::Release);
    __SQLITE3_KEYWORD_COUNT.store((*p_api).keyword_count, ::atomic::Ordering::Release);
    __SQLITE3_KEYWORD_NAME.store((*p_api).keyword_name, ::atomic::Ordering::Release);
    __SQLITE3_KEYWORD_CHECK.store((*p_api).keyword_check, ::atomic::Ordering::Release);
    __SQLITE3_STR_NEW.store((*p_api).str_new, ::atomic::Ordering::Release);
    __SQLITE3_STR_FINISH.store((*p_api).str_finish, ::atomic::Ordering::Release);
    __SQLITE3_STR_APPEND.store((*p_api).str_append, ::atomic::Ordering::Release);
    __SQLITE3_STR_APPENDALL.store((*p_api).str_appendall, ::atomic::Ordering::Release);
    __SQLITE3_STR_APPENDCHAR.store((*p_api).str_appendchar, ::atomic::Ordering::Release);
    __SQLITE3_STR_RESET.store((*p_api).str_reset, ::atomic::Ordering::Release);
    __SQLITE3_STR_ERRCODE.store((*p_api).str_errcode, ::atomic::Ordering::Release);
    __SQLITE3_STR_LENGTH.store((*p_api).str_length, ::atomic::Ordering::Release);
    __SQLITE3_STR_VALUE.store((*p_api).str_value, ::atomic::Ordering::Release);
    __SQLITE3_CREATE_WINDOW_FUNCTION
        .store((*p_api).create_window_function, ::atomic::Ordering::Release);
    __SQLITE3_NORMALIZED_SQL.store((*p_api).normalized_sql, ::atomic::Ordering::Release);
    __SQLITE3_STMT_ISEXPLAIN.store((*p_api).stmt_isexplain, ::atomic::Ordering::Release);
    __SQLITE3_VALUE_FROMBIND.store((*p_api).value_frombind, ::atomic::Ordering::Release);
    __SQLITE3_DROP_MODULES.store((*p_api).drop_modules, ::atomic::Ordering::Release);
    __SQLITE3_HARD_HEAP_LIMIT64
        .store((*p_api).hard_heap_limit64, ::atomic::Ordering::Release);
    __SQLITE3_URI_KEY.store((*p_api).uri_key, ::atomic::Ordering::Release);
    __SQLITE3_FILENAME_DATABASE
        .store((*p_api).filename_database, ::atomic::Ordering::Release);
    __SQLITE3_FILENAME_JOURNAL
        .store((*p_api).filename_journal, ::atomic::Ordering::Release);
    __SQLITE3_FILENAME_WAL.store((*p_api).filename_wal, ::atomic::Ordering::Release);
    __SQLITE3_CREATE_FILENAME
        .store((*p_api).create_filename, ::atomic::Ordering::Release);
    __SQLITE3_FREE_FILENAME.store((*p_api).free_filename, ::atomic::Ordering::Release);
    __SQLITE3_DATABASE_FILE_OBJECT
        .store((*p_api).database_file_object, ::atomic::Ordering::Release);
    __SQLITE3_TXN_STATE.store((*p_api).txn_state, ::atomic::Ordering::Release);
    __SQLITE3_CHANGES64.store((*p_api).changes64, ::atomic::Ordering::Release);
    __SQLITE3_TOTAL_CHANGES64
        .store((*p_api).total_changes64, ::atomic::Ordering::Release);
    __SQLITE3_AUTOVACUUM_PAGES
        .store((*p_api).autovacuum_pages, ::atomic::Ordering::Release);
    __SQLITE3_ERROR_OFFSET.store((*p_api).error_offset, ::atomic::Ordering::Release);
    __SQLITE3_VTAB_RHS_VALUE.store((*p_api).vtab_rhs_value, ::atomic::Ordering::Release);
    __SQLITE3_VTAB_DISTINCT.store((*p_api).vtab_distinct, ::atomic::Ordering::Release);
    __SQLITE3_VTAB_IN.store((*p_api).vtab_in, ::atomic::Ordering::Release);
    __SQLITE3_VTAB_IN_FIRST.store((*p_api).vtab_in_first, ::atomic::Ordering::Release);
    __SQLITE3_VTAB_IN_NEXT.store((*p_api).vtab_in_next, ::atomic::Ordering::Release);
    __SQLITE3_DESERIALIZE.store((*p_api).deserialize, ::atomic::Ordering::Release);
    __SQLITE3_SERIALIZE.store((*p_api).serialize, ::atomic::Ordering::Release);
