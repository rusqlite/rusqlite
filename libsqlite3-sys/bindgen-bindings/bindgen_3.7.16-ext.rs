...
pub const SQLITE_VERSION: &[u8; 7usize] = b"3.7.16\0";
pub const SQLITE_VERSION_NUMBER: i32 = 3007016;
pub const SQLITE_SOURCE_ID: &[u8; 61usize] =
    b"2013-03-18 11:39:23 66d5f2b76750f3520eb7a495f6247206758f5b90\0";
...
fn bindgen_test_layout_sqlite3_api_routines() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<sqlite3_api_routines>())).vsnprintf as *const _ as usize },
        1520usize,
        concat!(
            "Offset of field: ",
            stringify!(sqlite3_api_routines),
...
pub unsafe fn sqlite3_vsnprintf(
    ...
    ((*p_api).vsnprintf.expect(stringify!(
        "sqlite3_api contains null pointer for ",
        "vsnprintf",
        " function"
    )))(arg1, arg2, arg3, arg4)
