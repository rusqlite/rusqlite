...
pub const SQLITE_VERSION: &'static [u8; 7usize] = b"3.13.0\0";
pub const SQLITE_VERSION_NUMBER: i32 = 3013000;
pub const SQLITE_SOURCE_ID: &'static [u8; 61usize] =
    b"2016-05-18 10:57:30 fc49f556e48970561d7ab6a2f24fdd7d9eb81ff2\0";
...
pub const SQLITE_DBSTATUS_MAX: i32 = 10;
...
pub unsafe fn sqlite3_vsnprintf(
    ...
    ((*sqlite3_api).vsnprintf.expect(stringify!(
        "sqlite3_api contains null pointer for ",
        "vsnprintf",
        " function"
    )))(arg1, arg2, arg3, arg4)
